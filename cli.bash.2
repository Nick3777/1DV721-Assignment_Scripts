...
"  quote        	Print out a daily quote using local command."
"  oquote 	        Print out a daily quote from quotes.rest."
""
"Options:"
"  --help, -h     Print help."
...
function app-oquote
{
	curl -s http://quotes.rest/qod.json? | jq '.contents.quotes[].quote' | cowsay -f $(ls /usr/share/cowsay/cows/ | shuf -n1)
}
